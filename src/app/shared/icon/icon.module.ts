...
import { IconEyeLockComponent } from './icon-eye-lock';
...
import { IconMenuSkillsAndCertifications } from './studenthub-ui/icon-menu-skills-and-certifications';
import { IconMenuProjectShowcase } from './studenthub-ui/icon-menu-project-showcase';
import { IconEventsAndConference } from './studenthub-ui/icon-events-and-conference';
import { IconMenuInternships } from './studenthub-ui/icon-menu-internships';
import { IconMenuJobBoard } from './studenthub-ui/icon-menu-job-board';
import { IconMenuAlumniConnect } from './studenthub-ui/icon-menu-alumni-connect';
import { IconMenuCourseEngagement } from './studenthub-ui/icon-menu-course-engagement';
...
@NgModule({
    ...
    declarations: [
        ...
        IconMenuSkillsAndCertifications,
        IconMenuProjectShowcase,
        IconEventsAndConference,
        IconMenuInternships,
        IconMenuJobBoard,
        IconMenuAlumniConnect,
        IconMenuCourseEngagement
    ],
    exports: [
        IconMenuAppsComponent,
        IconMenuAuthenticationComponent,
